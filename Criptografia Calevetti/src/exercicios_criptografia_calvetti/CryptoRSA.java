...
public class CryptoRSA 
{
    ...
    public void geraParDeChaves(File fPub, File fPvk) throws
            IOException, NoSuchAlgorithmException, CertStoreException,
    ...
    public void geraCifra(byte[] texto, File fPub) throws NoSuchAlgorithmException, NoSuchPaddingException,
    ...
    public void geraDecifra(byte[] texto, File fPrv) throws NoSuchAlgorithmException, NoSuchPaddingException,
        InvalidKeyException, IllegalBlockSizeException, BadPaddingException,
        InvalidAlgorithmParameterException, IOException, ClassNotFoundException
    {
