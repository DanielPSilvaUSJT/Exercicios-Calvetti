...
public class CryptoAES
{
    ...
    public void geraChave (File fSim) throws IOException, NoSuchAlgorithmException, 
    ...
    public void geraCifra(byte[] texto, File fSim) throws NoSuchAlgorithmException,
    ...
    public void geraDecifra(byte[] texto, File fSim) throws NoSuchAlgorithmException,
        NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException,
        BadPaddingException, InvalidAlgorithmParameterException, IOException, ClassNotFoundException
    {
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(fSim));
